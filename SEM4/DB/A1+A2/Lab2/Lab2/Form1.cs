...
//this.parentBindingS = new BindingSource();
//this.childBindingS = new BindingSource();
...
//this.parentBindingS.DataSource = this.ds.Tables[parentTableName];
//this.childBindingS.DataSource = this.ds.Tables[childTableName];
